...
from widely adopted commercial tools to experimental prototypes. Key challenges identified include technical limitations related to context-awareness, operational constraints due to integration complexity and cloud dependencies, and legal concerns around data privacy. Future directions suggest extending the scope through additional repositories, integrating practitioner feedback, establishing automatic refinement loops, and enhancing classification methods with reinforcement learning. Continuous evaluation and updates are crucial, given the rapid technological evolution in Generative AI, to maintain relevance and practical
applicability.
\end{abstract-en}
